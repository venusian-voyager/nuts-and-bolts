...
use Voyager\Contracts\NutsAndBolts\MessageBag as MessageBagContract;
use Voyager\Contracts\NutsAndBolts\MessageProvider;
...
class MessageBag implements Jsonable, JsonSerializable, MessageBagContract, MessageProvider, Stringable
{
     ...
     *
     * @param  \Voyager\Contracts\NutsAndBolts\MessageProvider|array<string, array<string>>  $messages
     * @return $this
     */
    ...
    /**
     * Determine if messages exist for every given key.
     *
    ...
    /**
     * Determine if messages don't exist for every given key.
     *
     * @param  array|string|null  $key
     * @return bool
     */
    ...
    /**
     * Get every message from the message bag for a given key.
     *
     * @param  string  $key
     * @param  string|null  $format
    ...
    /**
     * Get every message for every key in the message bag.
     *
     * @param  string|null  $format
     * @return array<string>
     */
    ...
    /**
     * Get every unique message for every key in the message bag.
     *
     * @param  string|null  $format
     * @return array
     */
