...
trait InteractsWithData
{
     ...
     * @return mixed
     */
    abstract protected function data($key = null, $default = null): mixed;
     ...
     * @param  string  $key
     * @param  mixed  $default
     * @return \Voyager\NutsAndBolts\DataObjects\Stringable
     */
    public function str($key, $default = null): \Voyager\NutsAndBolts\DataObjects\Stringable
    {
     ...
     * @return \Voyager\NutsAndBolts\DataObjects\Stringable
     */
    public function string($key, $default = null): \Voyager\NutsAndBolts\DataObjects\Stringable
    {
     ...
     * @return float|int
     */
    public function clamp($key, $min, $max, $default = 0): float|int
    {
     ...
     */
    public function date($key, $format = null, $tz = null): ?\Voyager\NutsAndBolts\DataObjects\Carbon
    {
        $tz = enum_value($tz);
     ...
     */
    public function interval($key, $unit = null): ?CarbonInterval
    {
        if ($this->isNotFilled($key)) {
            return null;
        }
    ...
    /**
     * Get every datum except for a specified array of items.
     *
     * @param  mixed  $keys
     * @return array
     */
