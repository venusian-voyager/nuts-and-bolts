...
class EncodedHtmlString extends HtmlString
{
     ...
     * The HTML string.
     *
     * @var \Voyager\Contracts\NutsAndBolts\DeferringDisplayableValue|\Voyager\Contracts\NutsAndBolts\Htmlable|\BackedEnum|string|int|float|null
     */
    protected $html;
     ...
     *
     * @param  \Voyager\Contracts\NutsAndBolts\DeferringDisplayableValue|\Voyager\Contracts\NutsAndBolts\Htmlable|\BackedEnum|string|int|float|null  $html
