...
use Voyager\Contracts\NutsAndBolts\DeferringDisplayableValue;
...
if (! function_exists('e')) {
     ...
     *
     * @param  \Voyager\Contracts\NutsAndBolts\DeferringDisplayableValue|\Voyager\Contracts\NutsAndBolts\Htmlable|\BackedEnum|string|int|float|null  $value
...
if (! function_exists('optional')) {
     ...
     * @param  TValue  $value
     * @param  (callable(TValue): TReturn)|null  $callback
     * @return ($callback is null ? \Voyager\NutsAndBolts\Optional : ($value is null ? null : TReturn))
     */
...
if (! function_exists('str')) {
     ...
     * @return ($string is null ? object : \Voyager\NutsAndBolts\DataObjects\Stringable)
     */
