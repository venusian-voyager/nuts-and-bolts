...
/**
 * @method static \Voyager\Redis\Connections\Connection connection(\UnitEnum|string|null $name = null)
 * @method static \Voyager\Redis\Connections\Connection resolve(string|null $name = null)
 ...
 * @method static \Voyager\Redis\RedisManager extend(string $driver, \Closure $callback)
 * @method static void createSubscription(array|string $channels, \Closure $callback, string $method = 'subscribe')
 * @method static \Voyager\Redis\Limiters\ConcurrencyLimiterBuilder funnel(string $name)
 * @method static \Voyager\Redis\Limiters\DurationLimiterBuilder throttle(string $name)
 ...
 * @method static \Voyager\Redis\Connections\Connection setName(string $name)
 ...
 *
 * @see \Voyager\Redis\RedisManager
 */
class Redis extends MagicAlias
{
    /**
